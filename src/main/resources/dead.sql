...
INSERT INTO `article` VALUES ('2', null, 'elasticsearch java客户端', '', '', '0', 'admin', 'https://github.com/elastic/elasticsearch\r\n\r\nhttps://github.com/searchbox-io/Jest/tree/master/jest', '2016-06-19 21:21:49', '25', '10', 'markdown', '0', '3', '0', '2016-06-19 21:16:14', null, '2016-06-19 21:21:49', null, null);
...
INSERT INTO `article` VALUES ('17', null, '福建师大附中-1068-铺地毯', '', '', '0', 'admin', '题目描述\r\n\r\n为了准备一个独特的颁奖典礼，组织者在会场的一片矩形区域（可看做是平面直角坐标系的第一象限）铺上一些矩形地毯，一共有n张地毯，编号从 1 到n。现在将这些地毯按照编号从小到大的顺序平行于坐标轴先后铺设，后铺的地毯覆盖在前面已经铺好的地毯之上。\r\n地毯铺设完成后，组织者想知道覆盖地面某个点的最上面的那张地毯的编号。注意：在矩形地毯边界和四个顶点上的点也算被地毯覆盖。\r\n\r\n![](http://localhost:8080/dead/upload/image/2016/06/20/Lh5tn16aCh.png)\r\n\r\n输入\r\n\r\n输入共 n+2行。\r\n第一行有一个整数n，表示总共有 n张地毯。\r\n接下来的 n行中，第 i+1行表示编号 i的地毯的信息，包含四个正整数 a，b，g，k，每两个整数之间用一个空格隔开，分别表示铺设地毯的左下角的坐标（a，b）以及地毯在 x轴和 y轴方向的长度。\r\n第 n+2 行包含两个正整数 x 和 y，表示所求的地面的点的坐标（x，y）。\r\n\r\n输出\r\n\r\n输出共 1 行，一个整数，表示所求的地毯的编号；若此处没有被地毯覆盖则输出-1。\r\n\r\n样例输入\r\n\r\n3\r\n1 0 2 3\r\n0 2 3 3\r\n2 1 3 3\r\n2 2\r\n样例输出\r\n\r\n3\r\n提示\r\n\r\n数据范围：\r\n30% n&lt;=2\r\n50% 0&lt;=a,b,g,k&lt;=100\r\n100% 0&lt;=n&lt;=10000, 0&lt;=a,b,g,k&lt;=100000\r\nNOIP2011 DAY1 carpet\r\n\r\n来源\r\n\r\nNOIP2011\r\n\r\n```\r\n#include &lt;iostream&gt;\r\n#include&lt;fstream&gt;\r\nusing namespace std;\r\n\r\nconst int N = 10001;\r\n\r\nint main() {\r\n    ifstream fin(\"in.txt\");\r\n    cin.rdbuf(fin.rdbuf());\r\n//  ofstream fout(\"out.txt\");\r\n//  cout.rdbuf(fout.rdbuf());\r\n    int n, a[N], b[N], x[N], y[N], x1, y1;\r\n    cin &gt;&gt; n;\r\n    for (int i = 1; i &lt;= n; ++i)\r\n        cin &gt;&gt; a[i] &gt;&gt; b[i] &gt;&gt; x[i] &gt;&gt; y[i];\r\n    cin &gt;&gt; x1 &gt;&gt; y1;\r\n    for (int i = n; i &gt; 0; --i)\r\n        if (a[i] &lt;= x1 && a[i] + x[i] &gt;= x1 && b[i] &lt;= y1 && b[i] + y[i] &gt;= y1) {\r\n            cout &lt;&lt; i &lt;&lt; endl;\r\n            return 0;\r\n        }\r\n    cout &lt;&lt; -1 &lt;&lt; endl;\r\n    return 0;\r\n}\r\n\r\n#include &lt;iostream&gt;\r\n#include&lt;fstream&gt;\r\nusing namespace std;\r\n\r\nint a, b, x, y, n, arr[10001][10001] = { 0 };\r\n\r\n// 内存溢出\r\nint main() {\r\n    ifstream fin(\"in.txt\");\r\n    cin.rdbuf(fin.rdbuf());\r\n//  ofstream fout(\"out.txt\");\r\n    cin &gt;&gt; n;\r\n    for (int i = 1; i &lt;= n; ++i) {\r\n        cin &gt;&gt; a &gt;&gt; b &gt;&gt; x &gt;&gt; y;\r\n        for (int j = a; j &lt;= a + x; ++j)\r\n            for (int k = b; k &lt;= b + y; ++k)\r\n                arr[j][k] = i;\r\n    }\r\n    cin &gt;&gt; x &gt;&gt; y;\r\n    if (arr[x][y] == 0) {\r\n        cout &lt;&lt; -1;\r\n    } else {\r\n        cout &lt;&lt; arr[x][y];\r\n    }\r\n    return 0;\r\n}\r\n```', null, '21', '1', 'markdown', '0', '0', '0', '2016-06-20 00:16:44', null, '2016-06-22 18:45:58', null, null);
INSERT INTO `article` VALUES ('18', null, 'spring-boot-devtools', '', '', '0', 'admin', 'Triggering a restart\r\n\r\nAs DevTools monitors classpath resources, the only way to trigger a restart is to update the classpath. The way in which you cause the classpath to be updated depends on the IDE that you are using. In Eclipse, saving a modified file will cause the classpath to be updated and trigger a restart. In IntelliJ IDEA, building the project (Build → Make Project) will have the same effect.', '2016-06-20 16:05:30', '33', '3', 'markdown', '0', '3', '0', '2016-06-20 16:05:24', null, '2016-06-20 16:05:29', null, null);
INSERT INTO `article` VALUES ('19', null, 'make project automatically', '', '', '0', 'admin', '![](http://localhost:8080/dead/upload/image/2016/06/20/J93tNfZcxD.jpg)\r\n![](http://localhost:8080/dead/upload/image/2016/06/20/AWS7rPEBCD.jpg)\r\n![](http://localhost:8080/dead/upload/image/2016/06/20/bUOuXWOk6s.jpg)\r\n![](http://localhost:8080/dead/upload/image/2016/06/20/tpoo8FHFAm.jpg)\r\n![](http://localhost:8080/dead/upload/image/2016/06/20/CJUSueVl6x.jpg)\r\n![](http://localhost:8080/dead/upload/image/2016/06/20/AWNs64Ip3N.jpg)', null, '34', '7', 'markdown', '0', '0', '0', '2016-06-20 16:49:47', null, '2016-06-22 18:46:32', null, null);
INSERT INTO `article` VALUES ('20', null, 'markdown编辑器', '', '', '0', 'admin', 'https://pandao.github.io/editor.md\r\n\r\nhttps://github.com/tylingsoft/markdown-plus', null, '35', '2', 'markdown', '0', '0', '0', '2016-06-22 17:11:19', null, '2016-06-22 18:47:08', null, null);
INSERT INTO `article` VALUES ('21', null, 'redis安装', '', '', '0', 'admin', 'tar -zvxf redis-3.0.4.tar.gz\r\nmake\r\nmake install\r\n\r\n启动redis\r\nsrc/redis-server &\r\nsrc/redis-server redis.conf &\r\n\r\n客户端\r\n进入src\r\nredis-cli\r\nkeys *\r\nauth 密码\r\n\r\n配置密码\r\n在redis.conf\r\nrequirepass 密码\r\n\r\n', '2016-06-22 18:36:16', '36', '0', 'markdown', '0', '3', '0', '2016-06-22 18:35:30', null, '2016-06-22 18:36:15', null, null);
...
INSERT INTO `catalog` VALUES ('20', '面试题', '', '1', '0', '0', '0', '0', '0', '2016-06-19 21:29:26', null, null, null, null);
...
INSERT INTO `catalog` VALUES ('27', '其他', '', '1', '0', '0', '0', '0', '0', '2016-06-18 19:42:35', null, '2016-06-18 19:43:21', null, null);
INSERT INTO `catalog` VALUES ('28', '性能优化', '', '2', '27', '0', '0', '0', '0', '2016-06-19 21:31:35', null, null, null, null);
INSERT INTO `catalog` VALUES ('29', '建站', '', '2', '27', '0', '0', '0', '0', '2016-06-19 22:22:50', null, '2016-06-22 18:51:19', null, null);
...
INSERT INTO `catalog` VALUES ('33', '工具', '', '2', '27', '0', '0', '0', '0', '2016-06-20 16:04:32', null, '2016-06-22 18:51:51', null, null);
INSERT INTO `catalog` VALUES ('34', 'intellij idea', '', '3', '33', '0', '0', '0', '0', '2016-06-20 16:33:25', null, null, null, null);
INSERT INTO `catalog` VALUES ('35', 'markdown', '', '2', '27', '0', '0', '0', '0', '2016-06-22 15:33:42', null, '2016-06-22 18:51:33', null, null);
INSERT INTO `catalog` VALUES ('36', 'redis', '', '2', '17', '0', '0', '0', '0', '2016-06-22 18:34:28', null, null, null, null);
...
-- ----------------------------
INSERT INTO `search_log` VALUES ('1', 'markdown', '1', '0', '0', '2016-06-22 17:24:16', null, null, null, null);
INSERT INTO `search_log` VALUES ('2', 'elasticsearch', '1', '0', '0', '2016-06-22 18:45:03', null, null, null, null);
