...
<div class="content">
    ...
    <input type="button" class="btn btn-small btn-danger" value="删除"
           onclick="doBatch('ids', '${ctx}/admin/role/delete?ids=');">
    ...
    <table class="table table-bordered table-striped table-condensed">
        ...
        <tr>
            <th class="span1">
                <input type="checkbox" id="selectall" name="selectall"
                       onclick="selectAll('selectall', 'ids')">
            </th>
            <th>角色名</th>
            <th>状态</th>
            <th>排序</th>
        ...
        <c:forEach items="${page.datas }" var="data">
            <tr>
                ...
                <td>
                    <a href="${ctx }/admin/role/edit?id=${data.id }" title="${data.value }">
                        <font color=''>${data.value }</font>
                    </a>
                </td>
                <td>
                    <c:choose>
...
<script type="text/javascript">
    function edit() {
        window.location.href = '${ctx}/admin/role/edit';
    }
</script>