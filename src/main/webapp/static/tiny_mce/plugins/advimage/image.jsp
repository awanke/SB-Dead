...
<body id="advimage" style="display: none" role="application" aria-labelledby="app_title">
	...
	<form onsubmit="ImageDialog.insert();return false;" id="myForm" action="${ctx}/admin/article/uploadImage" method="post" enctype="multipart/form-data"> 
		<div class="tabs">
			<ul>
			...
			<div id="general_panel" class="panel current">
				<fieldset>
						...
						<table role="presentation" class="properties">
							...
							<tr>
								<td><label for="src_list">Local Image</label></td>
								<td nowrap>
							...
							<tr>
								<td>
									<label for="src_list">Add Watermark</label>
									<input type="checkbox" name="watermark" id="watermark" 
										style="width:13px;"  checked="checked" value="true" />
								</td>
								<td nowrap>
                                    <input type="button" id="uploadButton" value="Upload" 
                                    	style="width:60px;" onclick="AjaxUploadPic()" />
								</td>
							</tr>
								...
								function AjaxUploadPic() {
									$('#myForm').ajaxSubmit({
										beforeSubmit: function() {
											if ($("#imageFile").val() == "") {
												alert("Please select a local image first.");
												return;
											}
										},
