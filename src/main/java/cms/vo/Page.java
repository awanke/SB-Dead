...
public class Page implements Serializable {
    ...
    /**
     * Solr facet查询 - catalog
     */
    private List<Count> facetCatalog;
    ...
    public boolean isDisableHighlight() {
    ...
    /**
     * 获取Solr facet查询 - catalog
     */
    public List<Count> getFacetCatalog() {
        return facetCatalog;
    }

    /**
     * 设置Solr facet查询 - catalog
     */
    public void setFacetCatalog(List<Count> facetCatalog) {
